/**
 * Lexa convention format — the semantic ontology, adapted from ouroboros.
 *
 * A vault's convention is declarative data the user owns (lives in `vault/.lexa/`).
 * Lexa ships defaults in `core/ontology/` and enforces whatever the user declares.
 *
